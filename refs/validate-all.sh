...
yanglint -m -s ../ietf-*\@*.yang ietf-origin.yang ex-restconf-client.xml ../../trust-anchors/refs/ex-trust-anchors.xml ../../keystore/refs/ex-keystore.xml

echo "Testing ex-restconf-server.xml..."
yanglint -m -s ../ietf-*\@*.yang ietf-origin.yang ietf-x509-cert-to-name@2014-12-10.yang ex-restconf-server.xml ../../trust-anchors/refs/ex-trust-anchors.xml ../../keystore/refs/ex-keystore.xml
