...
pyang -f tree --tree-line-length 69 --tree-no-expand-uses ietf-restconf-client\@*.yang > ietf-restconf-client-tree-no-expand.txt
pyang -f tree --tree-line-length 69 --tree-no-expand-uses ietf-restconf-server\@*.yang > ietf-restconf-server-tree-no-expand.txt 

pyang -f tree --tree-line-length 69 ietf-restconf-client\@*.yang > ietf-restconf-client-tree.txt
pyang -f tree --tree-line-length 69 ietf-restconf-server\@*.yang > ietf-restconf-server-tree.txt
...
extract_grouping_with_params() {
  ...
  # $4 output filename
  pyang -f tree --tree-line-length 69 --tree-print-groupings $3 $1@*.yang | gsed -e 's/grouping restconf-client-grouping/grouping restconf-client-grouping ---> <empty>/' -e '/^ *+-- restconf-client-parameters/a\                +---u rcc:restconf-client-grouping' -e '/|     +-- restconf-client-parameters/a\       |        +---u rcc:restconf-client-grouping' > $1-groupings-tree.txt
